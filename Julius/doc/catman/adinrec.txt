...
DESCRIPTION
       adinrec records one spoken utterance from microphone to a file.

       Output  format  is  WAV,  16bit,  monoral, no compression.  If the file
       already exist, it will be overridden.  If filename of "-" is specified,
       recorded data will be output to stdout.
...
OPTIONS
       ...
       -margin msec
              Record margin before/after the detected  segment  (milliseconds,
              default=300)
